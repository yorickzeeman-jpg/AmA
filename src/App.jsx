...
// Merge: stored customisations win, but defaults supply any case types
// missing from the stored copy (e.g. added in a later release).
const merged = { ...WORKFLOW_TEMPLATES, ...parsed }
// Upgrade path: ship the 12-stage funeral claims workflow over older,
// shorter stored versions of these two types.
