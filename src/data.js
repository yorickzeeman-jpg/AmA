...
export const ROLE_PERMISSIONS = {
  ...
  billing_admin:    ['cases:read','cases:write','cases:assign','billing:read','billing:write'],
  financial_adviser:['cases:read','cases:write','cases:assign','internal:read','reports:read','employers:read'],
...
export const WORKFLOW_TEMPLATES = {
  ...
  'Exit': {
    ...
    steps: [
      step(1, 'Employer notification',          1),
      step(2, 'Verify employment end date',     1),
      step(3, 'Exit consultation',              2),
      step(4, 'Explain options',                1),
      step(5, 'Preservation advice',            1),
      step(6, 'Transfer processing',            3, ['Withdrawal Form', 'Investment Statement']),
      step(7, 'Submit',                         1, ['Submission Confirmation']),
      step(8, 'Close & notify billing',         1, [], 'create_billing_task'),
    ],
  },
  ...
  'Death - Funeral': {
    ...
    steps: [
      step(1,  'Verify contributions',                    1),
      step(2,  'Obtain relevant documents',               3, ['Death Certificate', 'ID Copy', 'Burial Order', 'Claim Form', 'Banking Details']),
      step(3,  'Extract information from documents (AI)', 1),
      step(4,  'Validate extracted information',          1),
      step(5,  'Complete claim form automatically',       1, ['Completed Claim Form']),
      step(6,  'Verify benefit and cover',                1),
      step(7,  'Register internal claim',                 1),
      step(8,  'Allocate to Claims Administrator',        1),
      step(9,  'Submit to insurer',                       1, ['Submission Confirmation']),
      step(10, 'Follow-up',                               5, [], 'create_followup_reminder'),
      step(11, 'Receive insurer feedback',                3),
      step(12, 'Approve / close claim',                   1),
    ],
  },
  ...
  'New': {
    ...
    steps: [
      step(1,  'Receive notification',            1),
      step(2,  'Verify employment',               1),
      step(3,  'Conduct induction',               2),
      step(4,  'Explain benefits',                1),
      step(5,  'Capture beneficiaries',           1, ['Beneficiary Nomination Form']),
      step(6,  'Capture financial information',   1),
      step(7,  'Financial consultation',          2),
      step(8,  'Retirement projection',           1),
      step(9,  'Submit',                          1, ['Completed Application']),
      step(10, 'Complete & notify billing',       1, [], 'create_billing_task'),
    ],
  },
